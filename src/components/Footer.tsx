        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-6">
            <div
              ...
              style={{ background: "aliceblue", width: "fit-content", borderRadius: '0.5rem' }}
            >
              <img src={logo} alt="CemStrong Logo" className="h-16 w-auto" />
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <MapPin
                  className="text-white/90 flex-shrink-0 mt-1"
                  size={18}
                />
              ...
              <li className="flex items-center space-x-3">
                ...
                <a
                  href="mailto:cemstrongproducts@gmail.com"
                  className="text-white/90 hover:text-white transition-colors text-sm"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="md:flex md:items-center md:justify-between">
            <p className="text-sm text-white/90">
              &copy; {currentYear} CemStrong Construction Products. All rights
              reserved.
            </p>
